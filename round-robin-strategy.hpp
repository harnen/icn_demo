...
class RoundRobinStrategyBase : public Strategy
{
public:
  void
 ...
 */
class RoundRobinStrategy : public RoundRobinStrategyBase
{
public:
  explicit
  RoundRobinStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
