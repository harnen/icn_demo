...
public class Camera2BasicFragment extends Fragment
        implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback/*, BackPressable*/ {
...
//        view.findViewById(R.id.info).setOnClickListener(this);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(getActivity().getFilesDir(), "pic"+System.currentTimeMillis()+".jpg");
    }
    ...
    private void saveFile(String path)
    {
        try {
            ...
            G.Log("Content "+ fileSize +" "+  buf.length +" "+inputFile.getName());

            Blob blob = new Blob(buf);
            Data contentData = new Data();
            contentData.setName(new Name(Config.prefix+inputFile.getName()));
            contentData.wireDecode(blob);*/

            G.Log("Content "+ inputFile.getName() +" "+  inputFile.length());
            ...
            Content c = new Content(inputFile.getName(),Config.prefix+inputFile.getName(),"Image to be processed",inputFile.getAbsolutePath());
            DatabaseHandler db = new DatabaseHandler(getContext());
            //G.Log("Content "+ inputFile.getName() +" "+ Config.prefix+inputFile.getName()+" "+  inputFile.getAbsolutePath()+" "+db.getContentCount());
            db.addContent(c);
            //G.Log("Content "+ c.getName().toString()+" "+db.getContentCount());
            //db.setContentDownloaded(c.getUri());

            /*File f = new File(getContext().getFilesDir()+"/"+c.getName()+".jpg");
