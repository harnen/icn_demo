...
public class G {
  ...
  private static final List<String> wifiTags = new ArrayList<>(Arrays.asList("ContentAdvertisement","WifiLink",WifiLink.class.getName()));

  /** Tag used in log output to identify NFD Service. */
  private static final String TAG = "NDNOcr";
