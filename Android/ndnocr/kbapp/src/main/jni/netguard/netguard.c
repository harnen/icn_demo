...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    const char *packet = "io/fluentic/ubicdn/net/vpn/Packet";
    clsPacket = jniGlobalRef(env, jniFindClass(env, packet));

    const char *allowed = "io/fluentic/ubicdn/net/vpn/Allowed";
    clsAllowed = jniGlobalRef(env, jniFindClass(env, allowed));

    const char *rr = "io/fluentic/ubicdn/net/vpn/ResourceRecord";
    clsRR = jniGlobalRef(env, jniFindClass(env, rr));

    const char *usage = "io/fluentic/ubicdn/net/vpn/Usage";
...
Java_io_fluentic_ubicdn_net_vpn_ServiceSinkhole_jni_1init(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_io_fluentic_ubicdn_net_vpn_ServiceSinkhole_jni_1start(
...
JNIEXPORT void JNICALL
Java_io_fluentic_ubicdn_net_vpn_ServiceSinkhole_jni_1stop(
...
Java_io_fluentic_ubicdn_net_vpn_ServiceSinkhole_jni_1get_1mtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}

JNIEXPORT jintArray JNICALL
Java_io_fluentic_ubicdn_net_vpn_ServiceSinkhole_jni_1get_1stats(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_io_fluentic_ubicdn_net_vpn_ServiceSinkhole_jni_1pcap(
...
JNIEXPORT void JNICALL
Java_io_fluentic_ubicdn_net_vpn_ServiceSinkhole_jni_1socks5(JNIEnv *env, jobject instance, jstring addr_,
...
JNIEXPORT void JNICALL
Java_io_fluentic_ubicdn_net_vpn_ServiceSinkhole_jni_1done(JNIEnv *env, jobject instance) {
...
Java_io_fluentic_ubicdn_net_vpn_Util_jni_1getprop(JNIEnv *env, jclass type, jstring name_) {
    const char *name = (*env)->GetStringUTFChars(env, name_, 0);
...
Java_io_fluentic_ubicdn_net_vpn_Util_is_1numeric_1address(JNIEnv *env, jclass type, jstring ip_) {
    jboolean numeric = 0;
...
void log_packet(const struct arguments *args, jobject jpacket) {
    ...
    const char *signature = "(Lio/fluentic/ubicdn/net/vpn/Packet;)V";
...
void dns_resolved(const struct arguments *args,
    ...
    const char *signature = "(Lio/fluentic/ubicdn/net/vpn/ResourceRecord;)V";
...
struct allowed *is_address_allowed(const struct arguments *args, jobject jpacket) {
    ...
    const char *signature = "(Lio/fluentic/ubicdn/net/vpn/Packet;)Lio/fluentic/ubicdn/net/vpn/Allowed;";
...
void account_usage(const struct arguments *args, jint version, jint protocol,
    ...
    const char *signature = "(Lio/fluentic/ubicdn/net/vpn/Usage;)V";
