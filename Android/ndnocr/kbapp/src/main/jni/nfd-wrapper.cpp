...
public:
 ...
 /*     "  default_level DEBUG\n"
      ...
      "    /ubicdn/video   /localhost/nfd/strategy/multicast\n"
      "  }\n"
      "}\n"
      "\n"
      "face_system\n"
...
Java_uk_ac_ucl_kbapp_KebappService_startNfd(JNIEnv* env, jclass, jobject jParams)
{
...
Java_uk_ac_ucl_kbapp_KebappService_getNfdLogModules(JNIEnv* env, jclass)
{
